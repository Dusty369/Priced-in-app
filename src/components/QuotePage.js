      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        {labourItems.length === 0 ? (
          <div className="p-10 text-center">
            ...
            <p className="text-gray-600 font-medium mb-1">No labour items yet</p>
            <p className="text-sm text-gray-500 mb-4">Add labour to include time costs in your quote</p>
            <button
              onClick={() => onAddLabourItem({ role: "builder", hours: 1, description: "Labour" })}
              className="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors duration-150 font-medium"
            >
            ...
            {labourItems.map(item => {
              ...
              return (
                <div key={item.id} className="px-5 py-4 flex items-center gap-4 hover:bg-gray-50 transition-colors duration-150">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <select
                        ...
                        className="px-2.5 py-1.5 border border-gray-300 rounded-lg text-sm font-medium focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                      >
                  ...
                  <div className="text-right w-24">
                    <p className="font-semibold text-gray-900">${cost.toFixed(2)}</p>
                  </div>
